...
var typeNum;
var defa;
$("#furniture").on('click','.allpic a',function(){
	var img=$("#furniture .allpic a").siblings("img");
    img.removeClass("obj")
    $(this).siblings("img").addClass("obj");
    //家具类型
...
/*素材展示*/
$("#material-img").on("click",".material-smallimg",function(){
        furid=$("#furnitureid").val();//家具id
		if(furid==""){
            Util.info2("请选择家具");
            return
		...
		if(typeNum==1){
			...
			$("#img-roof").attr("src", src);
			$("#img-roof").attr("sofaid", sofaid);
		}
		else if(typeNum==3){
