...
function(a) {
	...
	["width", "height"].forEach(function(b) {
		...
		if ("undefined" == typeof b) return a(this).dataset(); {
			if ("undefined" != typeof c) {
				for (var d = 0; d < this.length; d++) {
					var e = this[d];
					e.smElementDataStorage || (e.smElementDataStorage = {}), e.smElementDataStorage[b] = c
				}
				return this
			}
...
function(a) {
	...
	a.modalStack = [], a.modalStackClearQueue = function() {
		...
		var h = b.title ? '<div class="modal-title">' + b.title + "</div>" : "",
			i = b.text ? '<div class="modal-text">' + b.text + "</div>" : "",
			j = b.afterText ? b.afterText : "",
			k = b.buttons && 0 !== b.buttons.length ? "" : "modal-no-buttons",
			l = b.verticalButtons ? "modal-buttons-vertical" : "";
		e = '<div class="modal ' + k + '"><div class="modal-inner">' + (h + i + j) + '</div><div class="modal-buttons ' + l + '">' + f + "</div></div>", c.innerHTML = e;
		var m = a(c).children();
		return a(d.modalContainer).append(m[0]), m.find(".modal-button").each(function(c, d) {
			a(d).on("click", function(d) {
				b.buttons[c].close !== !1 && a.closeModal(m), b.buttons[c].onClick && b.buttons[c].onClick(m, d), b.onClick && b.onClick(m, c)
			})
		}), a.openModal(m), m[0]
		...
		a(d.modalContainer).append('<div class="preloader-indicator-overlay"></div><div class="preloader-indicator-modal"><span class="preloader preloader-white"></span></div>')
		...
		if (a(".modal.modal-in:not(.modal-out)").length && d.modalStack && e) return void a.modalStack.push(function() {
			a.openModal(b, c)
		});
		var f = b.hasClass("popup"),
		...
		var j;
		g || h || i || (0 !== a(".modal-overlay").length || f || a(d.modalContainer).append('<div class="modal-overlay"></div>'), 0 === a(".popup-overlay").length && f && a(d.modalContainer).append('<div class="popup-overlay"></div>'), j = a(f ? ".popup-overlay" : ".modal-overlay"));
		b[0].clientLeft;
		return b.trigger("open"), h && a(d.modalContainer).addClass("with-picker-modal"), g || h || i || j.addClass("modal-overlay-visible"), b.removeClass("modal-out").addClass("modal-in").transitionEnd(function(a) {
...
function(a) {
	...
	var b = !1,
		c = function(c) {
			...
			function e(a) {
				if (a.preventDefault(), !h.opened && (h.open(), h.params.scrollToInput)) {
					var b = h.input.parents(".page-content");
					if (0 === b.length) return;
					var c, d = parseInt(b.css("padding-top"), 10),
						e = parseInt(b.css("padding-bottom"), 10),
						f = b[0].offsetHeight - d - h.container.height(),
						g = b[0].scrollHeight - d - h.container.height(),
						i = h.input.offset().top - d + h.input[0].offsetHeight;
					if (i > f) {
						var j = b.scrollTop() + i - f;
						j + f > g && (c = j + f - g + e, f === g && (c = h.container.height()), b.css({
							"padding-bottom": c + "px"
						})), b.scrollTop(j, 300)
					}
				}
			...
			function g() {
				h.opened = !1, h.input && h.input.length > 0 && h.input.parents(".page-content").css({
					"padding-bottom": ""
			...
			return h.animating = !1, h.addValue = function(a) {
			...
			}, h.params.input && (h.input = a(h.params.input), h.input.length > 0 && (h.params.inputReadOnly && h.input.prop("readOnly", !0), h.inline || h.input.on("click", e), h.params.inputReadOnly && h.input.on("focus mousedown", function(a) {
				a.preventDefault()
				...
				h.close(), h.params.input && h.input.length > 0 && h.input.off("click focus", e), a("html").off("click", f)
			}, h.inline && h.open(), h
		};
...
function(a) {
	...
	var b = function(b) {
			...
			function d(a) {
				if (a.preventDefault(), !g.opened && (g.open(), g.params.scrollToInput)) {
					var b = g.input.parents(".page-content");
					if (0 === b.length) return;
					var c, d = parseInt(b.css("padding-top"), 10),
						e = parseInt(b.css("padding-bottom"), 10),
						f = b[0].offsetHeight - d - g.container.height(),
						h = b[0].scrollHeight - d - g.container.height(),
						i = g.input.offset().top - d + g.input[0].offsetHeight;
					if (i > f) {
						var j = b.scrollTop() + i - f;
						j + f > h && (c = j + f - h + e, f === h && (c = g.container.height()), b.css({
							"padding-bottom": c + "px"
						})), b.scrollTop(j, 300)
					}
				}
			...
			function f() {
				g.opened = !1, g.input && g.input.length > 0 && g.input.parents(".page-content").css({
					"padding-bottom": ""
			...
			return g.setValue = function(a, b) {
			...
			}, g.params.input && (g.input = a(g.params.input), g.input.length > 0 && (g.params.inputReadOnly && g.input.prop("readOnly", !0), g.inline || g.input.on("click", d), g.params.inputReadOnly && g.input.on("focus mousedown", function(a) {
				a.preventDefault()
			}))), g.inline || a("html").on("click", e), g.opened = !1, g.open = function() {
				g.opened || (g.layout(), g.inline ? (g.container = a(g.pickerHTML), g.container.addClass("picker-modal-inline"), a(g.params.container).append(g.container)) : (g.container = a(a.pickerModal(g.pickerHTML)), a(g.container).on("close", function() {
					f()
				...
				}), g.initialized ? g.value && g.setValue(g.value, 0) : g.params.value && g.setValue(g.params.value, 0)), g.opened = !0, g.initialized = !0, g.params.onOpen && g.params.onOpen(g)
			}, g.close = function() {
				g.opened && !g.inline && a.closeModal(g.container)
			}, g.destroy = function() {
				g.close(), g.params.input && g.input.length > 0 && g.input.off("click focus", d), a("html").off("click", e), a(window).off("resize", c)
			}, g.inline && g.open(), g
		};
	...
	function b(b) {
		...
		return this.each(function() {
			var f = a(this),
				...
				h = f.data("scroller");
			return h || f.data("scroller", h = new e(this, g)), "string" == typeof b && "function" == typeof h[b] && (d = h[b].apply(h, c), void 0 !== d) ? !1 : void 0
		}), void 0 !== d ? d : this
	}
	var c = function(a, b) {
			var c = a.split("."),
...
function(a) {
	...
	var b = function() {
			this.state = sessionStorage, this.state.setItem("stateid", parseInt(this.state.getItem("stateid") || 1) + 1), this.state.setItem("currentStateID", this.state.getItem("stateid")), this.stack = sessionStorage, this.stack.setItem("back", "[]"), this.stack.setItem("forward", "[]"), this.init(), this.xhr = null, this.newLoaded = !0
		};
	b.prototype.defaults = {}, b.prototype.init = function() {
		...
		var d = location.hash;
		if (b[0] && !b[0].id && (b[0].id = d ? d.slice(1) : this.genRandomID()), !b[0]) throw new Error("can't find .page element");
		var e = a(d);
		!e[0] || b[0] && d.slice(1) === b[0].id || (b.removeClass("page-current"), e.addClass("page-current"), b = e);
		...
		history.replaceState({
			url: g,
			id: f
		}, "", g), this.setCurrentStateID(f), this.pushBack({
			url: h,
			pageid: "#" + c[0].id,
			id: f
		}), window.addEventListener("popstate", a.proxy(this.onpopstate, this))
	}, b.prototype.loadPage = function(b) {
		this.newLoaded && (this.newLoaded = !1), this.getPage(b, function(c) {
		...
		e[0] && (this.pushForward({
			...
			pageid: "#" + d[0].id,
			id: this.getCurrentStateID()
		}), this.setCurrentStateID(c.id), this.animatePages(e, d, !0))
		...
		d[0] && (this.pushBack({
			...
			pageid: "#" + c[0].id,
			id: this.getCurrentStateID()
		}), this.setCurrentStateID(b.id), this.animatePages(c, d))
		...
		var b = a.state;
		if (!b || this.newLoaded) return void(this.newLoaded = !1);
		...
		this.dispatch("pageLoadStart"), this.xhr && this.xhr.readyState < 4 && (this.xhr.onreadystatechange = function() {}, this.xhr.abort(), this.dispatch("pageLoadCancel"));
		var d = this;
		this.xhr = a.ajax({
			url: b,
