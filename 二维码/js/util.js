var Util = (function () {
	...
	obj.prototype = {
		...
		info: function (msg) {
			...
			innerDiv.style.cssText = "display:inline-block;background-color:rgba(0,0,0,0.8);border-radius:3px;padding:8px 12px;color:white;font-size:14px";
		...
		showmsg: function (msg, funok, funcancel, key) {
			...
			var html="<div class='btn-fade fadeIn' id='"+id+"' style='z-index:9999999;'>";
		 ...
		 funok:function() {
			// body...
			var html='';
			html+='<div class="pay-fade"><div class="ub ub-ver ub-ac ub-pc pdt2"><img src="images/yes.png" style="width:3em"><div class="c4 pdtb ulev2">支付成功</div></div></div>';
			$("body").append(html);
			setTimeout(function(){
				$(".pay-fade").addClass("hide");
			},2000)
		},
