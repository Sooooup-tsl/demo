...
;(function(win,$){
    ...
    // 绑定swipeSlide
    $.fn.swipe = $.fn.swipeSlide = function(options){
    ...
    sS.prototype.init = function(options){
        ...
        function fnGetSlideDistance(){
            ...
            me._slideDistance = $(window).width()-50;
            // 定位
    ...
    function fnTouchend(me){
        ...
        // 距离大
            ...
            if('undefined' == typeof(me._moveDistance))return;
            // alert(me._moveDistance +':'+ me._distance);
            // 手指触摸上一屏滚动
